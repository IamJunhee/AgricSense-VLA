...
#include "jackal_msgs/msg/detail/feedback__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const jackal_msgs::msg::DriveFeedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const jackal_msgs::msg::Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: drivers
  {
    for (size_t i = 0; i < 2; i++) {
      jackal_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  jackal_msgs::msg::Feedback & ros_message)
{
  // Member: header
  ...
  {
    for (size_t i = 0; i < 2; i++) {
      jackal_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr,
        ros_message.drivers[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: drivers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        jackal_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: drivers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        jackal_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DriveFeedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = jackal_msgs::msg::Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const jackal_msgs::msg::Feedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<jackal_msgs::msg::Feedback *>(
    untyped_ros_message);
...
{
  return &jackal_msgs::msg::typesupport_fastrtps_cpp::_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jackal_msgs, msg, Feedback)() {
  return &jackal_msgs::msg::typesupport_fastrtps_cpp::_Feedback__handle;
}
